 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Test_PHPUnit_Constraint_DomQuery70 extends PHPUnit\Framework\Constraint\Constraint
{
    /**#@+
     ...
     */
    protected function fail($other, $description, \SebastianBergmann\Comparator\ComparisonFailure $cannot_be_used = NULL) : void
    {
        require_once 'Zend/Test/PHPUnit/Constraint/Exception.php';
